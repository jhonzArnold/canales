...
<body>
    ...
    <div class="main-container" style="display:none;">
        ...
        <div class="content-container" id="canales">
            <div class="channel-box">
                ...
                <button onclick="reproducirM3U8('https://alba-pe-atv-atv.stream.mediatiquestream.com/index.m3u8')">Ver ATV</button>
            </div>
            <div class="channel-box">
                <img src="dd.jfif" alt="Latina">
                <button onclick="reproducirM3U8('https://redirector.rudo.video/hls-video/567ffde3fa319fadf3419efda25619456231dfea/latina/latina.smil/playlist.m3u8')">Ver Canal Latina</button>
            </div>
            <div class="channel-box">
            ...
            <div class="channel-box">
                ...
                <button onclick="reproducirM3U8('http://181.78.105.146:2000/play/a03k/index.m3u8')">Ver Sony</button>
            </div>
            <div class="channel-box">
                <img src="gol.jpg" alt="Gol Peru">
                <button onclick="reproducirM3U8('https://bWFrZQ.la10tv.com:443/lb/golperu/index.m3u8?token=efc74c47304d5313bb3dd1fb9b75078fda5a0ac6-7a-1730099950-1730085550&id=38.250.154.17')">Ver Gol Peru</button>
            </div>
        </div>
        </div>
    ...
    <div class="channel-menu" id="channel-menu">
        <button onclick="reproducirM3U8('https://alba-pe-atv-atv.stream.mediatiquestream.com/index.m3u8')">Canal ATV</button>
        <button onclick="reproducirM3U8('https://redirector.rudo.video/hls-video/567ffde3fa319fadf3419efda25619456231dfea/latina/latina.smil/playlist.m3u8')">Canal Latina</button>
        ...
        <button onclick="reproducirM3U8('https://bWFrZQ.la10tv.com:443/lb/golperu/index.m3u8?token=efc74c47304d5313bb3dd1fb9b75078fda5a0ac6-7a-1730099950-1730085550&id=38.250.154.17')">Gol Peru</button>
    </div>
